<?php
 ...
 $admin_email = "info@heritageayurveda.de";  
  ...
  $subject = "Enquiry From heritageayurveda.de";
  $comment = $_REQUEST['message'];

 
$headers ="From: Enquiry From heritageayurveda.de ". strip_tags($email) ." <$email> \r\n";
...
$EmailMessageContent=   "Name: &nbsp " . $name."<br/>". "Email: &nbsp " . $email . " <br/> Phone: &nbsp " .$number. "<br/>Treatment Period : ". $dateFrom ." to ".$dateTo."<br/> Comment: &nbsp " . $comment;
...
//  $success =  @mail('jinoshaji@intellyze.com', 'subject','EmailMessageContent', $headers);

 $success = @mail($admin_email, $subject,$EmailMessageContent, $headers);
  $success =  @mail('nixonsunny@intellyze.com', $subject,$EmailMessageContent, $headers);
